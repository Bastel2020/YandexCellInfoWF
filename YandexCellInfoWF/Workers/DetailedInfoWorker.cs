...
namespace YandexCellInfoWF.Workers
{
    public static class DetailedInfoWorker
    {
        ...
        //public static async Task<bool> SearchEnbs(TextBox console, ProgressBar progressBar, Label currentEnb, string apiKey, string mccString, string mncString, string enbsString, string lacsString)
        //{
