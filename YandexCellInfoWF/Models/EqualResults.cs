...
namespace YandexCellInfoWF.Models
{
    ...
    {
        public List<DetailedInfoResults> DetailResults { get; set; }
        public List<ResultsModel<BaseItemInfo>> FastSearchResults { get; set; }

        public EqualResults(List<DetailedInfoResults> detailResults, List<ResultsModel<BaseItemInfo>> allInfoResults)
        {
